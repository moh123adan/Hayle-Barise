          ...
          {isSmallScreen ? (
            ...
            <>
              ...
              <Button
                variant="outline"
                size="icon"
                className="absolute -left-4 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-white shadow-lg hover:bg-gray-100"
                onClick={prevSlide}
              >
              ...
              <Button
                variant="outline"
                size="icon"
                className="absolute -right-4 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-white shadow-lg hover:bg-gray-100"
                onClick={nextSlide}
              >
